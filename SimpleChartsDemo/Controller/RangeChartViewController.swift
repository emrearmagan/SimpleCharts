...
class RangeChartViewController: UIViewController {
    ...
    @IBOutlet var legend: UIStackView!
    ...
    private func setupBarChart() {
        ...
        setConstraints()
        chartOptions()
        guard let chartView = chartView as? BarChartView else { return }
    ...
    private func setupRangeChart() {
        ...
        setConstraints()
        chartOptions()
        guard let chartView = chartView as? RangeBarChartView else { return }
...
extension RangeChartViewController {
    private func chartOptions() {
        guard let chartView = chartView as? BaseBarChartView else { return }
