...
class GroupChartViewController: UIViewController {
    @IBOutlet var groupedChartView: GroupedBarChartView!
...
enum entries {
    static let FacebookEntry: [BarEntryModel] = [
        BarEntryModel(value: 5214, color: UIColor(red: 24 / 255, green: 119 / 255, blue: 242 / 255, alpha: 1), label: "Facebook"),
        BarEntryModel(value: 4541, color: UIColor(red: 24 / 255, green: 119 / 255, blue: 242 / 255, alpha: 1), label: "Facebook"),
    ]

    static let InstagramEntry: [BarEntryModel] = [
        BarEntryModel(value: 12051, color: UIColor(red: 236 / 255, green: 96 / 255, blue: 86 / 255, alpha: 1), label: "Instagram"),
        BarEntryModel(value: 15413, color: UIColor(red: 236 / 255, green: 96 / 255, blue: 86 / 255, alpha: 1), label: "Instagram"),
    ]

    static let DribbbleEntry: [BarEntryModel] = [
        BarEntryModel(value: 2032, color: UIColor(red: 246 / 255, green: 117 / 255, blue: 167 / 255, alpha: 1), label: "Dribbble"),
        BarEntryModel(value: 1245, color: UIColor(red: 246 / 255, green: 117 / 255, blue: 167 / 255, alpha: 1), label: "Dribbble"),
    ]

    static let GithubEntry: [BarEntryModel] = [
        BarEntryModel(value: 1034, color: UIColor(red: 51 / 255, green: 51 / 255, blue: 51 / 255, alpha: 1), label: "Github"),
    ]

    static let TwitterEntry: [BarEntryModel] = [
        BarEntryModel(value: 10243, color: UIColor(red: 29 / 255, green: 161 / 255, blue: 242 / 255, alpha: 1), label: "Twitter"),
        BarEntryModel(value: 2135, color: UIColor(red: 29 / 255, green: 161 / 255, blue: 242 / 255, alpha: 1), label: "Twitter"),
    ]

    static let Spotify: [BarEntryModel] = [
        BarEntryModel(value: 600, color: UIColor(red: 29 / 255, green: 185 / 255, blue: 84 / 255, alpha: 1), label: "Spotify"),
    ]
}
