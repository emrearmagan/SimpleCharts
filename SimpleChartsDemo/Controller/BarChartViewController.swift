...
class BarChartViewController: UIViewController {
    ...
    @IBOutlet weak var barChartViewLarge: BarChartView!
    @IBOutlet weak var segment: UISegmentedControl!
    @IBOutlet weak var slider: UISlider!
    
    @IBOutlet weak var barChartViewSmall1: BarChartView!
    @IBOutlet weak var barChartViewSmall2: BarChartView!
    @IBOutlet weak var barChartViewExtraLarge: BarChartView!
    ...
    private func smallBarCharts() {
        ...
        entries = weekdays.compactMap({ weekday in
            return BarEntryModel(value: Double.random(in: 0...5), color: .orangeColor, label: weekday)
        })
